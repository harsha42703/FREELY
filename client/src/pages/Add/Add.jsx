      ...
      <div className="container">
        ...
        <div className="sections">
          <div className="left">
            ...
            <select name="category" style={{}} onChange={handleFormCange}>
              <option value=''>Category</option>
              {
                cards.map((item) => (
                  <option key={item.id} style={{BackgroundColor:"black"}} value={item.slug}>{item.slug[0].toUpperCase() + item.slug.slice(1)}</option>
                ))
              }
            </select>
          ...
          <div className="right">
            ...
            <form className='add' onSubmit={handleFormFeature}>
              <input type="text" placeholder='e.g. page design' style={{width:"100%"}} onChange={handleFormCange} />
